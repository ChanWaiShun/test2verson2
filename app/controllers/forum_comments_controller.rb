class ForumCommentsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @forum_comment.save
        format.html { redirect_to @forum_comment, notice: 'Forum comment was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @forum_comment.update(forum_comment_params)
        format.html { redirect_to @forum_comment, notice: 'Forum comment was successfully updated.' }
  ...
  private
    ...
    def forum_comment_params
      params.require(:forum_comment).permit(:user_name, :body, :forum_id)
    end
end
